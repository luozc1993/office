...
<head>
    ...
    <link rel="stylesheet" href="//at.alicdn.com/t/font_763913_9yqjetov3iv.css" />
    <style>
        .layui-tab{margin: 0}
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="/" class="logo">微办公</a>
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="seraph hideMenu iconfont icon-gengduo"></a>
            <!-- 顶级菜单 -->
            <ul class="layui-nav mobileTopLevelMenus" mobile>
                <li class="layui-nav-item" data-menu="contentManagement">
                    <a href="javascript:;"><i class="seraph iconfont icon-gengduo"></i><cite>菜单</cite></a>
                    <dl class="layui-nav-child" id="menuGroupsMobile">
            ...
            <ul id="menuGroupsPC" class="layui-nav topLevelMenus" pc>
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="/user/logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
